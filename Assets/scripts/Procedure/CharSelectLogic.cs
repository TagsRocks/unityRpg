...
namespace ChuMeng {
	public class CharSelectLogic : MonoBehaviour {
		public static CharSelectLogic charSelectLogic;
		...
		void ShowCharacterPanel() {
			//WindowMng.windowMng.ReplaceView ("UI/CharSelect");
			WindowMng.windowMng.PushView ("UI/CharSelect", false);
